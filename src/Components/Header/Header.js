  ...
  return (
    <header className="logged_header">
      <div className="header-left-wrapper">
        <div className="App-Switcher-Button-Wrapper">{svg_hd_left_1}</div>
        <div className="Home-Button-Wrapper">{svg_hd_left_2}</div>
      ...
      <div className="header-right-wrapper">
        <div className="Add-Wrapper">{svg_hd_right_1}</div>
        <div className="Info-Wrapper">{svg_hd_right_2}</div>
        <div className="Notifications-Wrapper">{svg_hd_right_3}</div>
