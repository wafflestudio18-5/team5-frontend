...
function Board({data}) { // TODO: 테스트 위해 아래에 임의로 DATA를 만들것임
  ...
  const DATA = {
    ...
    listnames: ['첫번째리스트', '두번째리스트', '세번째리스트', '네번째리스트', '다섯번째리스트', '여섯번째리스트', '일곱번째리스트', '여덟번째리스트', '아홉째리스트'],

    lists: [
      [{card_name: '카드하나'}, {card_name: '카드둘'}],
      [{card_name: '카드1번째'}, {card_name: '카드두번쨰'}, {card_name: '카드3번째'}, {card_name: '카드4번쨰'}, {card_name: '카드5번째'}, {card_name: '카드6번쨰'}, {card_name: '카드7번째'}, {card_name: '카드8번쨰'},  {card_name: '눈아프당엉엉엉'},  {card_name: '눈아프당엉엉엉'},  {card_name: '눈아프당엉엉엉'},  {card_name: '눈아프당엉엉엉'}],
      [{card_name: '카드하나'}, {card_name: '카드둘'}, {card_name: '카드3번째'}, {card_name: '카드4번쨰'}, {card_name: '카드5번째'}, {card_name: '카드6번쨰'},], 
      [{card_name: '카드하나'}, {card_name: '카드둘'}, {card_name: '눈아프당엉엉엉'}],
      [{card_name: '카드하나'}, {card_name: '카드둘'}],
